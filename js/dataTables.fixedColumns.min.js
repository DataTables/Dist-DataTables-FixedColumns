...
function(l){if(l instanceof k)return l;Object.isExtensible(l)&&d(l);return f(l)})}}if($jscomp.USE_PROXY_FOR_ES6_CONFORMANCE_CHECKS){if(a&&$jscomp.ES6_CONFORMANCE)return a}else if(g())return a;var m="$jscomp_hidden_"+Math.random();h("freeze");h("preventExtensions");h("seal");var p=0,c=function(b){this.id_=(p+=Math.random()+1).toString();if(b){b=$jscomp.makeIterator(b);for(var f;!(f=b.next()).done;)f=f.value,this.set(f[0],f[1])}};c.prototype.set=function(b,f){if(!e(b))throw Error("Invalid WeakMap key");
...
(f=""+ ++p,k.set(b,f)):f="p_"+b;var l=c.data_[f];if(l&&$jscomp.owns(c.data_,f))for(c=0;c<l.length;c++){var u=l[c];if(b!==b&&u.key!==u.key||b===u.key)return{id:f,list:l,index:c,entry:u}}return{id:f,list:l,index:-1,entry:void 0}},h=function(c,b){var f=c.head_;return $jscomp.iteratorPrototype(function(){if(f){for(;f.head!=c.head_;)f=f.previous;for(;f.next!=f.head;)return f=f.next,{done:!1,value:b(f)};f=null}return{done:!0,value:void 0}})},m=function(){var c={};return c.previous=c.next=c.head=c},p=0;
return e},"es6","es3");
...
this.s.barWidth=d.offsetWidth-d.clientWidth>=h?h:0;this.dom.rightTopBlocker.css("width",this.s.barWidth+1);this.dom.leftTopBlocker.css("width",this.s.barWidth+1);this.dom.rightBottomBlocker.css("width",this.s.barWidth+1);this.dom.leftBottomBlocker.css("width",this.s.barWidth+1)}d=null;h=this.s.dt.column(0).header();var m=null;null!==h&&(h=a(h),m=h.outerHeight()+1,d=a(h.closest("div.dataTables_scroll")).css("position","relative"));var p=this.s.dt.column(0).footer(),c=null;null!==p&&(p=a(p),c=p.outerHeight(),
null===d&&(d=a(p.closest("div.dataTables_scroll")).css("position","relative")));for(var b=this.s.dt.columns().data().toArray().length,f=0,l=0,u=a(this.s.dt.table().node()).children("tbody").children("tr"),w=0,A=new Map,q=0;q<b;q++){var r=this.s.dt.column(q);0<q&&A.set(q-1,w);if(r.visible()){var x=a(r.header());r=a(r.footer());if(q-w<this.c.left){a(this.s.dt.table().node()).addClass(this.classes.tableFixedLeft);d.addClass(this.classes.tableFixedLeft);if(0!==q){var n=this.s.dt.column(q-1-w,{page:"current"});
n.visible()&&(f+=a(n.nodes()[0]).outerWidth(),l+=l+=n.header()?a(n.header()).outerWidth():n.footer()?a(n.header()).outerWidth():0)}for(var t=0,v=u;t<v.length;t++)n=v[t],a(a(n).children()[q-w]).css(this._getCellCSS(!1,f,"left")).addClass(this.classes.fixedLeft);x.css(this._getCellCSS(!0,l,"left")).addClass(this.classes.fixedLeft);r.css(this._getCellCSS(!0,l,"left")).addClass(this.classes.fixedLeft)}else{t=0;for(v=u;t<v.length;t++)n=v[t],n=a(a(n).children()[q-w]),n.hasClass(this.classes.fixedLeft)&&
n.css(this._clearCellCSS("left")).removeClass(this.classes.fixedLeft);x.hasClass(this.classes.fixedLeft)&&x.css(this._clearCellCSS("left")).removeClass(this.classes.fixedLeft);r.hasClass(this.classes.fixedLeft)&&r.css(this._clearCellCSS("left")).removeClass(this.classes.fixedLeft)}}else w++}null===h||h.hasClass("index")||(this.s.rtl?(this.dom.leftTopBlocker.outerHeight(m),d.append(this.dom.leftTopBlocker)):(this.dom.rightTopBlocker.outerHeight(m),d.append(this.dom.rightTopBlocker)));null===p||p.hasClass("index")||
(this.s.rtl?(this.dom.leftBottomBlocker.outerHeight(c),d.append(this.dom.leftBottomBlocker)):(this.dom.rightBottomBlocker.outerHeight(c),d.append(this.dom.rightBottomBlocker)));t=l=f=0;for(q=b-1;0<=q;q--)if(r=this.s.dt.column(q),r.visible())if(x=a(r.header()),r=a(r.footer()),v=A.get(q),void 0===v&&(v=w),q+t>=b-this.c.right){a(this.s.dt.table().node()).addClass(this.classes.tableFixedRight);d.addClass(this.classes.tableFixedRight);q+1+t<b&&(n=this.s.dt.column(q+1+t,{page:"current"}),n.visible()&&(f+=
a(n.nodes()[0]).outerWidth(),l+=n.header()?a(n.header()).outerWidth():n.footer()?a(n.header()).outerWidth():0));for(var y=0,z=u;y<z.length;y++)n=z[y],a(a(n).children()[q-v]).css(this._getCellCSS(!1,f,"right")).addClass(this.classes.fixedRight);x.css(this._getCellCSS(!0,l,"right")).addClass(this.classes.fixedRight);r.css(this._getCellCSS(!0,l,"right")).addClass(this.classes.fixedRight)}else{y=0;for(z=u;y<z.length;y++)n=z[y],n=a(a(n).children()[q-v]),n.hasClass(this.classes.fixedRight)&&n.css(this._clearCellCSS("right")).removeClass(this.classes.fixedRight);
x.hasClass(this.classes.fixedRight)&&x.css(this._clearCellCSS("right")).removeClass(this.classes.fixedRight);r.hasClass(this.classes.fixedRight)&&r.css(this._clearCellCSS("right")).removeClass(this.classes.fixedRight)}else t++;h&&(this.s.rtl?(this.dom.leftTopBlocker.outerHeight(m),d.append(this.dom.leftTopBlocker)):(this.dom.rightTopBlocker.outerHeight(m),d.append(this.dom.rightTopBlocker)));p&&(this.s.rtl?(this.dom.leftBottomBlocker.outerHeight(c),d.append(this.dom.leftBottomBlocker)):(this.dom.rightBottomBlocker.outerHeight(c),
d.append(this.dom.rightBottomBlocker)))};e.prototype._getCellCSS=function(d,h,m){return"left"===m?this.s.rtl?{position:"sticky",right:h+(d?this.s.barWidth:0)+"px"}:{left:h+"px",position:"sticky"}:this.s.rtl?{left:h+"px",position:"sticky"}:{position:"sticky",right:h+(d?this.s.barWidth:0)+"px"}};e.prototype._clearCellCSS=function(d){return"left"===d?this.s.rtl?{position:"",right:""}:{left:"",position:""}:this.s.rtl?{left:"",position:""}:{position:"",right:""}};e.prototype._setKeyTableListener=function(){var d=
this;this.s.dt.on("key-focus",function(h,m,p){h=a(p.node()).offset();m=a(a(d.s.dt.table().node()).closest("div.dataTables_scrollBody"));if(0<d.c.left){var c=a(d.s.dt.column(d.c.left-1).header()),b=c.offset(),f=c.outerWidth();h.left<b.left+f&&(c=m.scrollLeft(),m.scrollLeft(c-(b.left+f-h.left)))}0<d.c.right&&(c=d.s.dt.columns().data().toArray().length,p=a(p.node()).outerWidth(),b=a(d.s.dt.column(c-d.c.right).header()).offset(),h.left+p>b.left&&(c=m.scrollLeft(),m.scrollLeft(c-(b.left-(h.left+p)))))});
this.s.dt.on("draw",function(){d._addStyles()});this.s.dt.on("column-reorder",function(){d._addStyles()});this.s.dt.on("column-visibility",function(){setTimeout(function(){d._addStyles()},50)})};e.version="4.0.1-dev";e.classes={fixedLeft:"dtfc-fixed-left",fixedRight:"dtfc-fixed-right",leftBottomBlocker:"dtfc-left-bottom-blocker",leftTopBlocker:"dtfc-left-top-blocker",rightBottomBlocker:"dtfc-right-bottom-blocker",rightTopBlocker:"dtfc-right-top-blocker",tableFixedLeft:"dtfc-has-left",tableFixedRight:"dtfc-has-right"};
e.defaults={i18n:{button:"FixedColumns"},left:1,right:0};return e}();(function(e){"function"===typeof define&&define.amd?define(["jquery","datatables.net"],function(d){return e(d,window,document)}):"object"===typeof exports?module.exports=function(d,h){d||(d=window);h&&h.fn.dataTable||(h=require("datatables.net")(d,h).$);return e(h,d,d.document)}:e(window.jQuery,window,document)})(function(e,d,h){function m(c,b){void 0===b&&(b=null);c=new p.Api(c);b=b?b:c.init().fixedColumns||p.defaults.fixedColumns;
return new k(c,b)}a=e;g=a.fn.dataTable;var p=e.fn.dataTable;e.fn.dataTable.FixedColumns=k;e.fn.DataTable.FixedColumns=k;d=e.fn.dataTable.Api.register;d("fixedColumns()",function(){return this});d("fixedColumns().left()",function(c){var b=this.context[0];return void 0!==c?(b._fixedColumns.left(c),this):b._fixedColumns.left()});d("fixedColumns().right()",function(c){var b=this.context[0];return void 0!==c?(b._fixedColumns.right(c),this):b._fixedColumns.right()});e.fn.dataTable.ext.buttons.fixedColumns=
{action:function(c,b,f,l){e(f).attr("active")?(e(f).removeAttr("active").removeClass("active"),b.fixedColumns().left(0),b.fixedColumns().right(0)):(e(f).attr("active",!0).addClass("active"),b.fixedColumns().left(l.config.left),b.fixedColumns().right(l.config.right))},config:{left:1,right:0},init:function(c,b,f){void 0===c.settings()[0]._fixedColumns&&m(c.settings(),f);e(b).attr("active",!0).addClass("active");c.button(b).text(f.text||c.i18n("buttons.fixedColumns",c.settings()[0]._fixedColumns.c.i18n.button))},
text:null};e(h).on("init.dt.dtfc",function(c,b){"dt"===c.namespace&&(b.oInit.fixedColumns||p.defaults.fixedColumns)&&(b._fixedColumns||m(b,null))})})})();
